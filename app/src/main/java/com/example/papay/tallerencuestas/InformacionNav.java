...
public class InformacionNav extends Fragment {
    ...
    public void tomarFoto(View view) {
        ...
        String filePath = Environment.getExternalStorageDirectory() + txtNombreProyectoInformacion.getText().toString() + ".jpg";
        ...
        String dir = getActivity().getExternalFilesDir(null) + "/" + txtNombreProyectoInformacion.getText().toString() + ".jpg";
    ...
    public void recuperarFoto(View view) {
        ...
        Bitmap bitmap1 = BitmapFactory.decodeFile(getActivity().getExternalFilesDir(null) + "/" + txtNombreProyectoInformacion.getText().toString() + ".jpg");
